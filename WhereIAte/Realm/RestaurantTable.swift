...
class RestaurantTable: Object {
    ...
    convenience init(id: String, name: String, roadAddress: String, phoneNumber: String, placeURL: String, city: String, latitude: Double, longitude: Double, registeredDate: Date) {
        self.init()
